...
@Setter
@NoArgsConstructor
public class FirstInfoRow {

  @Cell(
      column = 0,
      cols = 2,
      cellType = CellType.STRING,
      style = @CellStyle(alignment = HorizontalAlignment.CENTER),
      ignoreParse = true
  )
  ...
  @Builder
  public FirstInfoRow(String supplierText, String supplierValue, String ordererText,
      String ordererValue) {
